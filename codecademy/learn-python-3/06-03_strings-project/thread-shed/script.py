...
for i in daily_transactions_split:
  customer = i[0].strip()
  sale = i[1].strip()
  thread_sold = i[2].strip()
  date = i[3].strip()
  transactions_clean.append([customer, sale, thread_sold, date])
print("-----------------task 9------------")
...
for i in colors:
  num = color_count(i)
  print("Thread Shed sold {NUM} threads of {COLOR} thread today.".format(NUM=num, COLOR=i))